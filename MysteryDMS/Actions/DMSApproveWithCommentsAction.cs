...
namespace MysteryDMS.Actions
{
    ...
    [PublishedAction(input_type: typeof(AddCommentInput), url = nameof(DMSApproveWithCommentsAction))]
    class DMSApproveWithCommentsAction : BaseMysteryAction<AddCommentInput, ContentActionOutput>, IContentActionButton
    {
        public DMSApproveWithCommentsAction() : base()
        {
        }


        public DMSApproveWithCommentsAction(DMSVersion version, User user) 
        {
        ...
        protected override ActionResult<ContentActionOutput> ActionImplemetation()
        {
            ...
            version.wf_Status = DMSConstants.wf_approved_w_comments;
        ...
        public string label { get { return "DMS.VERSION.APPROVE_WITH_COMMENT"; } }
        ...
        public Modal modal
        {
            get
            {
                return new Modal()
                {
                    controller = "dms_approve_w_commments_controller as c",
