...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="file-preview {class}">\n' +
                ...
                '    </div>\n' +
                '</div>';
            //toni tClose = '<div class="close fileinput-remove">&times;</div>\n';
            ...
            //noinspection HtmlUnknownAttribute
            //toni tBtnBrowse = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>';
            tBtnBrowse = '<button tabindex="500" class="{css}" {status}>{icon} {label}</button>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-xs btn-danger btn-outline',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fa fa-upload"></i>',
                    uploadClass: 'btn btn-xs btn-success btn-outline',
                    uploadTitle: 'Upload file',
                    zoomIcon: '<i class="fa fa-search-plus"></i>',
                    zoomClass: 'btn btn-xs btn-primary btn-outline',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="glyphicon glyphicon-menu-hamburger"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fa fa-warning text-warning"></i>',
        ...
        _renderMain: function () {
            var self = this,
                ...
                //toni caption = self.captionTemplate.setTokens({ 'class': css + ' kv-fileinput-caption' });
                caption = self.captionTemplate.setTokens({ 'class': css + ' kv-fileinput-caption glowing-border' });
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-primary btn-outline',
        removeIcon: '<i class="fa fa-trash"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        //toni uploadLabel: 'Upload',
        uploadLabel: '',
        //toni uploadTitle: 'Upload selected files',
        uploadTitle: '',
        msgNo: 'No',
